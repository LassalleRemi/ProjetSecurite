		...
		{	
			if(p.role.equals("A")){%>
				...
				<ul class='nav nav-pills nav-justified'>
					...
					<li role='presentation' class='btn btn-default btn-lg'><a href='Maj.jsp'>Paramètre</a></li>
		  ...
		  <%}
			if(p.role.equals("M")){%>
				...
				<ul class='nav nav-pills nav-justified'>
					...
					<li role='presentation' class='btn btn-default btn-lg'><a href='Maj.jsp'>Modifier vos infos</a></li>
					<li role='presentation' class='btn btn-default btn-lg'><a href='Deconnection.jsp'>Déconnexion</a></li>
				</ul>
				</nav>
				</div>
